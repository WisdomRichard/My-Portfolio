    ...
    return (
        <section className={`${style.paddingX} flex flex-col py-[3rem] gap-[2rem] pb-[2rem]`}>
            <div
                ...
                <div
                    className={`flex flex-col gap-[2rem] justify-center lg:justify-start content-center lg:content-start items-center lg:items-start mt-4 md:mt-0 text-left h-full w-full`}>
                    <h1 className={`text-2xl md:text-4xl lg:text-5xl font-extrabold font-poppins text-center lg:text-left text-transparent bg-clip-text bg-gradient-to-br from-[#C33764] to-[#1D2671] leading-10`}>
                        ...
                        <span className={`text-[16px] lg:text-[20px] xl:text-[25px] capitalize`}>Building User-Friendly Web Experiences</span> </h1>
                    <p className={`font-manrope ${style.paragraph}`}>Hi, I&apos;m Wisdom, a passionate Front-End React Developer
                        based in Abuja, Nigeria, with a passion for
                        creating beautiful, functional,
                        user-centered and visually stunning interfaces and digital experiences. I bring websites and applications to life
                    ...
                    <p className={`${style.paragraph}`}>Whether I&apos;m working on a website, mobile app, or other digital product, I bring my commitment to design excellence and user-centered thinking to every project I work on. I look forward to the opportunity to bring my skills and passion to your next project.</p>
                </div>
            </div>
            <div>
