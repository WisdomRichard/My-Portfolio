...
const NavLink = (props) => {
    ...
    return (
        <Link href={props.href}
              className={`${props.classname} block py-2 pl-3 pr-4 text-[#ADB7BE] sm:text-[16px] font-manrope rounded md:p-0 hover:text-white relative group ${pathname === props.href ? 'text-white' : 'text-dimWhite'}`}>
            {props.title}
